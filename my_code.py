...
x=0
while x<=9:
    if locations['a1']==locations['a2']==locations['a3']!=' ' or locations['b1']==locations['b2']==locations['b3']!=' ' or locations['c1']==locations['c2']==locations['c3']!=' ' or locations['a1']==locations['b1']==locations['c1']!=' 'or locations['a2']==locations['b2']==locations['c2']!=' ' or locations['a3']==locations['b3']==locations['c3']!=' ' or locations['a1']==locations['b2']==locations['c3']!=' ' or locations['a3']==locations['b2']==locations['c1']!=' ':#allwins
            print("Game Over!")
            break
    elif x==9:
            print("Its a tie")
            mt_tik_tak_toe
            break #measures if all boxes are filled
    else:
